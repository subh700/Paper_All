...
\author[SUBHAM KUMAR]{\begin{tabular}{ccc} \begin{tabular}[c]{ccc} \footnotesize Presented By-\\ \small SUBHAM KUMAR\\ \scriptsize (\Enroll) \end{tabular} & \begin{tabular}[c]{ccc}\includegraphics[scale=0.16]{setting/logo} \end{tabular} & \begin{tabular}[c]{ccc} \footnotesize Under the Supervision of\\ \small Dr. VIPIN KUMAR \\ \scriptsize Assistant Professor. \end{tabular} \end{tabular}}
